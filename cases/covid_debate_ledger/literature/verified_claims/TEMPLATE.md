...
- Primary sources only. Never log a claim from a news article, blog, or press release.
...
judgement record; under `edge_assessments: required` it MUST (a non-trivial
