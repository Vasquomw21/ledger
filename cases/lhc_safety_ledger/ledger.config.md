...
project_name:        lhc_safety_ledger
project_root:        <absolute path on disk>
deliverable:         report
source_of_truth:     markdown+quartz
the_reader:          a science journalist AND a sceptical physicist
source_types:        peer-reviewed papers, institutional FAQ, historical technical report
...
gated_paths:         content/concept_notes/, content/literature_reviews/, content/inquiry.md, content/assessments/, content/baseline_comparison.md, content/finding.md
...
# Synthesis-claim gate (tools/check_synthesis.py). off · warn · required. Scans the synthesis
# prose for unanchored significance/superiority claims. ON here (required) so this case holds its
# own synthesis prose to the anchoring standard. HONEST LIMIT: enforces anchoring (form), not
# truth; aptness is the adversarial assist.
